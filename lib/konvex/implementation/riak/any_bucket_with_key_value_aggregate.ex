defmodule Konvex.Implementation.Riak.AnyBucketWithKeyValueAggregate do
  @doc """
  Regular Riak bucket with any values (stored as binaries) CRUD-client extended with
  ...
  defmacro __using__(
    ...
    quote do
      ...
      use Konvex.Implementation.Riak.Ability.ToCheckKeyExists,
          ...
          value_type: :text
      use Konvex.Implementation.Riak.Ability.ToGetAllAnyKeyValues,
          bucket_name: unquote(quoted_bucket_name),
          connection: unquote(quoted_riak_connection),
